...
{
    public static class HyperlinkAPs
    {
        private const string IS_EXTERNAL_PROPERTY = "IsExternal";
        public static readonly DependencyProperty IsExternalProperty = DependencyProperty.RegisterAttached(IS_EXTERNAL_PROPERTY, typeof(bool), typeof(HyperlinkAPs), new UIPropertyMetadata(false, OnIsExternalChanged));
