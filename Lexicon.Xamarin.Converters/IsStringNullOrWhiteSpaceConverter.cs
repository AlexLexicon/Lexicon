...
{
    public class IsStringNullOrWhiteSpaceConverter : LexiconConverter
    {
        ...
        public bool GetResult(object value, bool invert) => value == null ? !invert : invert ^ string.IsNullOrWhiteSpace(value.ToString());
    }
}